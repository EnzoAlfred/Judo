...
<div>
    ...
    <div style="text-align: center; border: 3px solid #000000; margin-right: 30%; margin-left: 30%;border-radius: 8px;box-shadow: 5px 5px 6px #000000;">
        <br/><div>
            <a href="index.php?controleur=gestionBoutique&action=afficherUnProduit&produit=<?php echo $unProduit['idP'] ?>"><img alt="<?php echo $unProduit['nomP']; ?>" src="<?php echo $unProduit['img']; ?>"/></a>
        </div>
